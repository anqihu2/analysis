...
source <- read.csv("/Users/jojohu/Downloads/QLABBLASTProject-Participantsource_DATA_LABELS_2022-10-16_0830.csv", stringsAsFactors = F)

colnames(source)  <- str_remove(colnames(source), "How.was.this.participant.recruited...choice.")

spark_diagnosis <- read.csv("/Users/jojohu/Documents/Qlab/blast_online_data/demographic_data/spark_diagnosis.csv")
...
df1 <- as.data.frame(do.call(rbind, str_split(spark_diagnosis$diagnosis_source_latest, "\\|")))

data.frame(row = rownames(df1), 
...
# ADOS scores
ados <- read.csv("/Users/jojohu/Documents/Qlab/bucld_2019_followup/drive_checklist.csv")

ados %>%
  dplyr::select(Participant.ID, ados_overall, ados_comparison, ados_severity) %>%
  filter(Participant.ID %in% allData_asd$part_id)
```
...
ggsave("/Users/jojohu/Documents/Qlab/manuscript_jndd/rsr_composite_ling.png",
...
ggsave("/Users/jojohu/Documents/Qlab/iascl_2019_2020/iascl_2021/composite_ssl_age.png",
        bg="transparent", width = 15, height = 15, units = "cm")
```
...
ggsave("/Users/jojohu/Documents/Qlab/iascl_2019_2020/iascl_2021/ssl_lsl_acc.png",
        bg="transparent", width = 15, height = 15, units = "cm")
```
