...
```
## SL Cross-sectional Development Analyses: Younger group model has isSingular Warnings
```{r}
...
# Younger group has isSingular Warnings
age_composite_m3 <- 
...
## SL Cross-sectional Development Analyses: Post-hoc t-test of Linguistic SL Composite Scores in each age group
```{r}
...
# Section 6: Letter and Syllable SL analyses
...
## Letter and Syllable SL analyses: Compare composite LSL and composite SSL relationship based on Age
```{r}
...
## Letter and Syllable SL analyses: Follow-up on composite LSL and composite SSL relationship in each age group
```{r}
...
## Letter and Syllable SL analyses: Extract Pearson's R between composite LSL and composite SSL in each age group 
```{r} 
getCorrCI <- 
...
## Letter and Syllable SL analyses: Simple correlation comparison on composite LSL and SSL relationship in TD vs. ASD
```{r}
library(cocor)
