...
```{r}
# The descriptive stats on the poster are based on the corr subjects.csv (26 subjects)
# The bar graph are based on 29 auditory subjects (auditory_sl_subject.csv), and 27 visual subjects (auditory_sl_subject.csv)
#Set up current working directory
setwd ("/Users/jojohu/Documents/in_scanner_beh_analysis/in_scanner_analysis_08_10_19")

# Read in in-scanner behavioral data
visual_data <- read.csv("adult_in_scanner_visual_behavioral_all_runs_08_08_19.csv")
auditory_data <-
  read.csv("adult_in_scanner_auditory_behavioral_all_runs_08_08_19.csv")
...
write.csv(visual_data, "visual_sl_subject.csv")
...
write.csv(auditory_data, "auditory_sl_subject.csv")
...
corr_raw_data <- cbind(matched_auditory_data, matched_visual_data)

describe(matched_visual_data)

write.csv(corr_raw_data, "corr_subject.csv")
...
write.csv(bar_mean_rt_all, "rt_subject.csv")
...
write.csv(visual_data, "example.csv")

write.csv(bar_rt_slope_all, "rt_slope_subject.csv")
