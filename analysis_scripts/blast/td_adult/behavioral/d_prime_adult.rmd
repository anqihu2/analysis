...
# Data paths all changed to blast adult data paths throughout
...
# Output path
output_path <- ("/Users/jojohu/Documents/Qlab/blast_online_data/data_summaries/blast_online_adult/breakdown/acc_by_trial/")
...
loop_index = 0 
exp_phase <- list()
# Adult exposure phase ends with a different stimulus name from blast children data does
for (id in all_ids) { 
  loop_index = loop_index +1
...
# write.csv(d_prime_by_trial, "/Users/jojohu/Documents/Qlab/manuscript_development/d_prime_all_trial_adult_td.csv", row.names = F)
```