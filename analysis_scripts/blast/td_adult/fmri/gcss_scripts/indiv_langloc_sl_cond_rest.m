function indiv_langloc_sl_cond_rest(opts, group, prefix, part_id)
...
opts.PARCEL_DIR = [opts.PROJECT_DIR 'data/nilearn_pipeline/fedorenko_mask/indiv_langloc_parcels/bin_resampled_mask/' group '/' part_id '/'];
%% To troubleshoot, uncomment the line below:
%% opts.PARCEL_DIR = [opts.PROJECT_DIR 'data/nilearn_pipeline/fedorenko_mask/indiv_langloc_parcels/bin_resampled_mask/adult/044/'];
opts.SUBJ_DEFINE_DATA_DIR = [opts.PROJECT_DIR 'data/nilearn_pipeline/fedorenko_mask/indiv_langloc_parcels/asl_cond_minus_rest/' group '/' part_id '/'];
%% To troubleshoot, uncomment the line below:
%% opts.SUBJ_DEFINE_DATA_DIR = [opts.PROJECT_DIR 'data/nilearn_pipeline/fedorenko_mask/indiv_langloc_parcels/asl_cond_minus_rest/adult/044/'];
opts.RESULTS_DIR = [opts.PROJECT_DIR 'data/nilearn_pipeline/fedorenko_mask/indiv_langloc_parcels/asl_cond_minus_rest/' group '/results/'];
%% To troubleshoot, uncomment the line below:
%% opts.RESULTS_DIR = [opts.PROJECT_DIR 'data/nilearn_pipeline/fedorenko_mask/indiv_langloc_parcels/asl_cond_minus_rest/adult/results/'];
disp(opts)
