...
opts.SUBJ_DEFINE_DATA_DIR = [opts.PROJECT_DIR 'data/nilearn_pipeline/fedorenko_mask/indiv_langloc_parcels/asl_str_minus_rand/' group '/' part_id '/'];
%% To troubleshoot, uncomment the line below:
%% opts.SUBJ_DEFINE_DATA_DIR = [opts.PROJECT_DIR 'data/nilearn_pipeline/fedorenko_mask/indiv_langloc_parcels/asl_str_minus_rand/adult/044/'];
opts.RESULTS_DIR = [opts.PROJECT_DIR 'data/nilearn_pipeline/fedorenko_mask/indiv_langloc_parcels/asl_str_minus_rand/' group '/results/'];
%% To troubleshoot, uncomment the line below:
%% opts.RESULTS_DIR = [opts.PROJECT_DIR 'data/nilearn_pipeline/fedorenko_mask/indiv_langloc_parcels/asl_str_minus_rand/adult/results/'];
disp(opts)
