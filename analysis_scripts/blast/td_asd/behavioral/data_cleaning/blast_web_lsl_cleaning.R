...
input_path <- 
  "/Users/jojohu/Documents/Qlab/blast_online_data/online_sl/blast_child/"

#Change input path to run predictable lsl. 
# input_path <-
#  "/Users/jojohu/Documents/Qlab/blast_online_data/online_sl/blast_child/predictable_lsl/"
...
output_path <-
  "/Users/jojohu/Documents/Qlab/blast_online_data/data_summaries/blast_online_child_lsl_clean/"

#Use two output paths if you are not sure what the comments above means
# output_path <-
#  "/Users/jojohu/Documents/Qlab/blast_online_data/data_summaries/blast_online_child_lsl_clean/predictable_lsl/"
...
# orig <- read.csv("/Users/jojohu/Documents/Qlab/blast_online_data/data_summaries/blast_online_child_lsl_clean/lsl_800ms_long_trial_indiv_count.csv",)

# count_800ms_files <- rbind(orig[,-1], count_800ms_files)

setdiff(files, count_800ms_files$subject_id)
setdiff(count_800ms_files$subject_id, files)
