...
write.csv(indiv_rts, paste0(output_path, "blast_online_children_tsl_indiv_rts.csv"))
...
write.csv(as.data.frame(tsl_test_phase), paste0(output_path, "acc_by_trial/blast_online_children_tsl_test_phase.csv"))
...
write.csv(tsl_entropy_by_triplet[,5:6], 
          paste0(output_path, "blast_online_children_tsl_entropy.csv"))
#Save accuracy
write.csv(tsl_acc_table, paste0(output_path, "blast_online_children_tsl_accuracies.csv"))
