...
setwd("/Users/jojohu/Documents/Qlab/blast_online_data/online_sl/blast_child/predictable_lsl")
...
write.csv(as.data.frame(lsl_test_phase), paste0(output_path, "acc_by_trial/blast_online_children_lsl_predictable_test_phase.csv"))
...
write.csv(lsl_entropy_by_triplet[,5:6], 
          paste0(output_path, "blast_online_children_lsl_predictable_entropy.csv"))
#Save mean accuracy
write.csv(lsl_acc_table,
          paste0(output_path, "blast_online_lsl_predictable_2afc_accuracies.csv"))
#Save accuracy by trial
write.csv(lsl_accuracy[,c(1:5)], paste0(output_path, "acc_by_trial/blast_lsl_predictable_acc_by_trial.csv"))
