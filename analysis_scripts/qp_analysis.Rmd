...
print(ineligible_part_spoli[c("part_id")])
```
...
input_path4 <- "spoli/data_summaries/breakdown/acc_by_trial"
...
write.csv(acc_trial, "bucld_2019_followup/acc_trial.csv")
...
input_path6 <- 
  "spoli/data_summaries/breakdown/rt_by_trial"
...
```{r, include = F}
# Script from: http://www.cookbook-r.com/Graphs/Plotting_means_and_error_bars_(ggplot2)/#error-bars-for-within-subjects-variables
