...
drive_checklist <-
  read.csv("bucld_2019_followup/drive_checklist.csv")
...
bucld_demo_all <- read.csv("bucld_2019_followup/bucld_demo_all_manually_editted.csv")
...
#Read in GJT data 
gjt <- read.csv("bucld_2019_followup/gjt_score.csv")
#Read in analyzed behavioral data
bucld_blast_data_list <- 
  list.files(path = "bucld_2019_followup/",
...
# More Data Prep
```{r, include = FALSE}
bucld_scq_web <- read.csv("bucld_2019_followup/bucld_demo_all_manually_editted.csv")
...
#Remove 198 who has no demo info and has only one SL task completed
...
gjt_original_file <- read.csv("bucld_2019_followup/gjt_score.csv")
...
# RSR Clean
```{r}
rsrh <- read.csv("bucld_2019_followup/rsr_home.csv")
rsrlab <- read.csv("bucld_2019_followup/rsr_lab.csv")
...
gjt_total <- read.csv("bucld_2019_followup/gjt_score.csv")
...
ssl_rt_hit_count <- read.csv("bucld_2019_followup/ssl_rt_hit_trial_count.csv")
tsl_rt_hit_count <- read.csv("bucld_2019_followup/tsl_rt_hit_trial_count.csv")
vsl_rt_hit_count <- read.csv("bucld_2019_followup/vsl_rt_hit_trial_count.csv")
lsl_rt_hit_count <- read.csv("bucld_2019_followup/lsl_rt_hit_trial_count.csv")
...
```{r, eval=F, include = F}
input_path3 <- 
  "blast_online_data/data_summaries/blast_online_child/breakdown/acc_by_trial/acc_by_trial"
...
```{r, include = F, eval = F}
input_path4 <- 
  "blast_online_data/data_summaries/blast_online_child/breakdown/acc_by_trial/rt_by_trial"
